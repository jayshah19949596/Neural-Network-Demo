...
import Shah_02_02 as s02  # This module is for plotting components
import Shah_02_03 as s03  # This module is for graphic components


class WidgetsWindow(tk.Tk):
	def __init__(self):
		print("init", tf.__version__)
		tk.Tk.__init__(self)
